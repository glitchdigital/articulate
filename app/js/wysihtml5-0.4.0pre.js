...
wysihtml5.views.View = Base.extend(
  ...
  var dom             = wysihtml5.dom,
      ...
      ADDITIONAL_CSS_RULES = [
        "html                 { height: 100%; }",
        "body             { min-height: 100%; padding: 10px; padding-top: 5px; margin: 0; margin-top: -1px; }",
        "body, body p, body * { font-family: sans-serif; font-size: 16px; }",
        "body > p:first-child { margin-top: 5px; }",
