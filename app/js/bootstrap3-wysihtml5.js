    ...
    var templates = {
        "font-styles": "<li class='dropdown'>" +
                           "<a class='btn btn-default dropdown-toggle' data-toggle='dropdown' href='#'>" +
                               "<i class='icon-font'></i>&nbsp;<span class='current-font'>Text</span>&nbsp;<b class='caret'></b>" +
                           "</a>" +
                           "<ul class='dropdown-menu'>" +
                               "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='div'>Text</a></li>" +
        ...
        "emphasis":    "<li>" +
                           "<div class='btn-group'>" +
                               "<a class='btn btn-default' data-wysihtml5-command='bold' title='CTRL+B'>B</a>" +
                               "<a class='btn btn-default' data-wysihtml5-command='italic' title='CTRL+I'>I</a>" +
                               "<a class='btn btn-default' data-wysihtml5-command='underline' title='CTRL+U'>U</a>" +
                           "</div>" +
                       "</li>",
        "lists":       "<li>" +
                           "<div class='btn-group'>" +
